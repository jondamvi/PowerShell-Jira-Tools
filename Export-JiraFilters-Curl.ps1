...
while ($hasMorePages) {
    ...
    if ($useAdminMode) {
        $pageUrl = "$jiraBaseUrl/secure/admin/filters/ViewSharedFilters.jspa?filterView=search&Search=Search&filterView=search&searchName=&searchOwnerUserName=&searchShareType=any&pagingOffset=$pageOffset&sortAscending=true&sortColumn=name"
    } else {
        $pageUrl = "$jiraBaseUrl/secure/ManageFilters.jspa?filterView=search&Search=Search&filterView=search&searchName=&searchOwnerUserName=&searchShareType=any&pagingOffset=$pageOffset&sortAscending=true&sortColumn=name"
    }
